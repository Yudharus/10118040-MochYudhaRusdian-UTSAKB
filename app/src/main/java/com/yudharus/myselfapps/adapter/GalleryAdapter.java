...
public class GalleryAdapter extends RecyclerView.Adapter<GalleryAdapter.GalleryView>{
    ...
    public GalleryAdapter(Activity activity,List<Integer> imageList) {
    ...
    @NonNull
    @Override
    public GalleryAdapter.GalleryView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull GalleryAdapter.GalleryView holder, int position) {

...
import com.yudharus.myselfapps.databinding.ActivityHomeBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.appBarHome.fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Yudarus MySelfApps, Isinya banyak nanti diisi sendiri aja", Snackbar.LENGTH_LONG)
